...
This branch targets Minecraft 26.1. Other supported versions live on their own branches, each an independently maintained port (changes aren't shared automatically between them):

| Branch | Minecraft version |
|---|---|
| `1.20.1` | 1.20.1 |
| `1.21.1` | 1.21.1 |
| `26.1` | 26.1 (this branch) |
...
- [Fabric API](https://modrinth.com/mod/fabric-api) 0.145.1+26.1
- Java 25+
