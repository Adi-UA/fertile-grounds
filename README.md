...
This branch targets Minecraft 26.2. Other supported versions live on their own branches, each an independently maintained port (changes aren't shared automatically between them):
