...
public final class ModBlocks {
  ...
  public static final Block ENRICHED_DIRT =
      registerBlockWithItem("enriched_dirt", new Block(ModBlockProperties.dirtProperties()));
  ...
  public static final Block SUPER_ENRICHED_DIRT =
      registerBlockWithItem("super_enriched_dirt", new Block(ModBlockProperties.dirtProperties()));
  ...
  /** Wires up hoe-tilling for the two dirt tiers. */
